...
export class AddImageToProduct1789281801293 implements MigrationInterface {
    name = 'AddImageToProduct1789281801293'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`image\` varchar(200) NULL`);
